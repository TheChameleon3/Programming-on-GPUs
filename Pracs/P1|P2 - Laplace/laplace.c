...
// ON CPU - 0.226184 seconds
// ON GPU - 0.156805 seconds
// THe reason for the speed up is because the data is not being
// copied in and out of the kernels on each execution of code -
// instead the code is being copied in then computed then when all the code
// has been executed it is being copied back to the host (CPU)  
